...
Route::post('warehouses', [WarehouseController::class, 'getFromDB'])->name('warehouses');
...
Route::get('delivery', [DeliveryCostService::class, 'deliveryCost'])->name('delivery-cost-service');
